...
1. You only need to upload `0-main.c` and `main.h` for this task. We will provide our own `positive_or_negative()` function.
2. You are not allowed to add or remove lines of code, you may change only one line in this task.
---
